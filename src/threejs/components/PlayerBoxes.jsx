...
const Box = ({ position, color, args = [1, 1, 1], material, rotation, ref }) => {
  return (
...
const Tail = ({ material }) => {
  ...
  return (
    <group ref={tailRef} name="tail">
      ...
      <Box args={[1, 0.75, 0.6]} position={[-0.5, 0.05, 0]} material={material} />
      <group ref={tailSecondRef} position={[-1, 0, 0]}>
        ...
        <Box args={[0.6, 0.6, 0.3]} position={[-0.1, 0, 0]} material={material} />
        <group ref={tailThirdRef} position={[-0.4, 0, 0]}>
          ...
          <Box args={[0.75, 0.4, 0.1]} position={[-0.1, 0.15, 0]} rotation={[0, 0, -10]} material={material} />
          {/* <RoundedBox
            args={[0.75, 0.4, 0.1]}
            position={[-0.1, -0.15, 0]}
            radius={0.05}
...
const Player = () => {
  ...
  const material = useMemo(() => <BodyMaterial color="#e07e28" />);

  // console.log("memo -->", bodyMaterial);
  ...
  return (
    <group ref={playerPhysicsRef} name="player-physics-object">
      <group ref={playerBodyRef} name="player-body-group">
        ...
        <Box args={[1.5, 1.2, 0.8]} position={[0.25, 0.1, 0]} material={material} />
        {/* <RoundedBox
        ...
        <Box args={[0.7, 0.5, 0.8]} position={[0.8, -0.25, 0]} material={material} />
        {/* <RoundedBox
        ...
        <Box args={[0.5, 0.5, 0.05]} position={[0.25, 0.7, 0]} rotation={[0, 0, 10]} material={material} />
        <RoundedBox
          ref={leftFinRef}
        ...
        {/* <Box ref={leftFinRef} args={[0.5, 0.1, 0.6]} position={[0, -0.25, 0.4]} material={material} /> */}
        <RoundedBox
          ref={rightFinRef}
        ...
        {/* <Box ref={rightFinRef} args={[0.5, 0.1, 0.6]} position={[-0, -0.25, -0.4]} material={material} /> */}
        <RoundedBox
          name="player-lips"
          args={[0.1, 0.1, 0.5]}
          position={[1.11, -0.3, 0]}
        ...
        {/* <Box args={[0.1, 0.1, 0.5]} position={[1.11, -0.3, 0]} material={material} /> */}
