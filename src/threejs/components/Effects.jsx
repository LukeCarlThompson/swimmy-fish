...
const PostProcessing = () => {
  ...
  return (
    <EffectComposer>
      <Bloom intensity={0.75} luminanceThreshold={0.3} luminanceSmoothing={0.9} height={500} />
      {/* <ChromaticAberration
        blendFunction={BlendFunction.NORMAL} // blend mode
        offset={[0.001, 0.001]} // color offset
      /> */}
      {/* <Vignette eskil={false} offset={0.01} darkness={0.5} /> */}
      <DepthOfField ref={dofRef} focusDistance={0.086} focalLength={0.1} bokehScale={1} height={480} />
